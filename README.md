...
4. Crie/Referencie uma nova **branch** e nomeie como `feat/community/Lenderson`:'git checkout -b feat/community/Lenderson'
    > Exemplo: 'git checkout -b feat/community/lendersonmoreira'
